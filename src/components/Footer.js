      ...
      <div className="container mx-auto px-4 flex justify-center items-center gap-4 max-w-6xl">
        <div className="grid grid-cols-4 gap-4 w-full">
          ...
          <div className="space-y-4">
            ...
            <Link to="mailto:abhishek.flrntis@gmail.com" className="flex items-center text-gray-400 hover:text-white transition-all duration-300 ease-out text-sm font-openSans group">
              ...
              <span className="ml-2 relative">abhishek.flrntis@gmail.com<span className="absolute -bottom-0.5 left-0 w-0 h-px bg-white transition-all duration-300 ease-out group-hover:w-full"></span></span>
            </Link>
