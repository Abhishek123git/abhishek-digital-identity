      ...
      <div className="container mx-auto px-4 flex justify-center items-center gap-4 max-w-6xl">
        <div className="grid grid-cols-4 gap-4 w-full">
          <div className="space-y-4 ">
            <h4 className="text-white font-semibold font-openSans underline underline-offset-4 decoration-[#6c5ce7]">En. Abhishek Kumar</h4>
          ...
          <div className="space-y-4 grid grid-col ">
            <h4 className="text-white font-semibold font-openSans underline underline-offset-4 decoration-[#6c5ce7]">Quick Links</h4>
          ...
          <div className="space-y-4">
            <h4 className="text-white font-semibold font-openSans underline underline-offset-4 decoration-[#6c5ce7]">Get in Touch</h4>
          ...
          <div className="space-y-4">
            <h4 className="text-white font-semibold font-openSans underline underline-offset-4 decoration-[#6c5ce7]">Connect</h4>
