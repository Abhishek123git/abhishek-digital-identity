    ...
    <>
      <section className="grid grid-rows-3 gap-2 p-3 border border-gray-600 mx-auto my-10 max-w-6xl h-auto rounded-lg">
        <div className="grid gap-2 place-items-center rounded-lg p-2">
          <div className="flex flex-col justify-center items-center">
            <img src="images/profile.webp" alt="Profile" className="flex-auto w-[20%] h-auto rounded-lg hover:scale-105 transition-transform duration-300" />
      ...
      <section className="grid grid-rows-2 gap-2 p-3 border border-gray-600 mx-auto my-10 max-w-6xl h-auto rounded-lg">        
        ...
        <div className="grid grid-cols-4 gap-2 p-3 w-full mx-auto">                          
          <CodingMilestones alt="LeetCode" src="images/leetcode.webp" link="https://leetcode.com/u/abhishek1445747/" />
          <CodingMilestones alt="HackerRank" src="images/hackerrank.webp" link="https://www.hackerrank.com/profile/mp1445747" />
          <CodingMilestones alt="CodeChef" src="images/codechef.webp" link="https://www.codechef.com/users/codermjo123" />
          <CodingMilestones alt="GeeksforGeeks" src="images/geeksforgeeks.webp" link="https://www.geeksforgeeks.org/profile/abhishekdeveloper" />                    
        </div>
      </section>
