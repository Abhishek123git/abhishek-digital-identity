...
const About = () => {
  ...
  return (
    <>
      ...
      <section className="grid grid-rows-[auto_auto_auto] gap-2 p-3 border border-gray-600 mx-auto my-6 sm:my-10 max-w-6xl h-auto rounded-lg">
        <div className="grid gap-2 place-items-center rounded-lg p-2">
          <div className="flex flex-col justify-center items-center">
            <img src={`${process.env.PUBLIC_URL}/images/profile.webp`} alt="Profile" fetchPriority="high" width={250} height={250} className="flex-auto w-40 h-40 sm:w-56 sm:h-56 md:w-[250px] md:h-[250px] rounded-lg hover:scale-105 transition-transform duration-300" />
            <span className="text-white px-2 py-4 text-center text-xl sm:text-2xl font-semibold" style={{ "fontFamily": "Courgette, Comic Sans MS" }}>Abhishek Kumar</span>
            <span className="block text-sm bg-[#b2bec3] rounded-lg px-4 py-2 text-gray-800 font-semibold mt-1">Full Stack Developer</span>
          </div>
        </div>
        <div className="rounded-lg px-4 sm:px-6 py-6 sm:py-8">
          <h1 className="text-2xl sm:text-3xl md:text-4xl mb-5 font-semibold text-purple-500">Digital Identity</h1>
          <p className="text-gray-400 mb-4 text-sm sm:text-base text-justify">
            <span className="text-3xl sm:text-4xl text-[#ffc048]">I</span>'m <span className="font-bold text-[#f1f2f6] underline underline-offset-2 decoration-transparent hover:decoration-[#EA2027] transition-colors ease-in-out duration-300">Abhishek Kumar</span>, a dynamic Full Stack Software Engineer and technology based in Delhi NCR, India, driven by a passion for building scalable, impactful solutions that solve real-world problems.
          </p>
          <p className="text-gray-400 mb-4 text-sm sm:text-base text-justify">
          ...
          <p className="text-gray-400 mb-4 text-sm sm:text-base text-justify">
            Full Stack Developer with hands-on experience in <TbBrandCSharp className="inline-block mr-1 size-4 sm:size-5" />, <BiLogoJava className="inline-block mr-1 size-4 sm:size-5" />, <GrReactjs className="inline-block mr-1 size-4 sm:size-5" />, <TbBrandJavascript className="inline-block mr-1 size-4 sm:size-5" />, and <BsFillDatabaseFill className="inline-block mr-1 size-4 sm:size-5" />. Skilled in building scalable web applications using ASP.NET, Web API, and responsive UI with <GrReactjs className="inline-block mr-1 size-4 sm:size-5" />, <DiJqueryLogo className="inline-block mr-1 size-4 sm:size-5" />, and <FaBootstrap className="inline-block mr-1 size-4 sm:size-5" />.
            I’ve contributed to company websites and enterprise apps, working across both front-end and back-end. Proficient with tools like <FaGithub className="inline-block mr-1 size-4 sm:size-5" aria-label="GitHub" />, <SiJira className="inline-block mr-1 size-4" aria-label="Jira" />, <DiVisualstudio className="inline-block mr-1 size-4 sm:size-5" aria-label="Visual Studio" />, and <VscVscode className="inline-block mr-1 size-4 sm:size-5" aria-label="VS Code" />.
            With a B.Tech in IT, I'm focused on growing as a full stack developer and creating clean, efficient digital solutions.
          </p>
        </div>
        <div className="px-4 sm:px-6 py-6 sm:py-8 border-t border-gray-600">
          <h1 className="flex items-center text-2xl sm:text-3xl mb-5 font-semibold text-purple-500 group"><MdStarPurple500 className="items-center mr-2 size-7 sm:size-8 animate-pulse group-hover:text-[#ffa801] transition-colors duration-300" />Highlights &amp; Successes</h1>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-2 mt-4">
          ...
          <div className="mt-6">
            <h1 className="flex items-center text-2xl sm:text-3xl mb-5 font-semibold text-purple-500 group"><CgMoreO className="items-center mr-2 size-5 sm:size-6 animate-pulse group-hover:text-[#ffa801] transition-colors duration-300" />Extra Curricular Activities</h1>
            <span className="text-gray-400 mb-4 text-sm sm:text-base text-justify">Apart from developement, some things I like are :</span>
            <ul className="text-gray-400 pt-4 text-sm sm:text-base text-justify">
              <li className="mb-2 group"><ImArrowRight className="inline-block mr-2 size-4 sm:size-5 transform transition-all duration-300 ease-out group-hover:translate-x-1 group-hover:text-[#ffa801]" />Gym freak and technophile</li>
              <li className="mb-2 group"><ImArrowRight className="inline-block mr-2 size-4 sm:size-5 transform transition-all duration-300 ease-out group-hover:translate-x-1 group-hover:text-[#ffa801]" />Problem Solving & Coding Challenges on multiple platforms like HackerRank, LeetCode, CodeChef</li>
              <li className="mb-2 group"><ImArrowRight className="inline-block mr-2 size-4 sm:size-5 transform transition-all duration-300 ease-out group-hover:translate-x-1 group-hover:text-[#ffa801]" />Traveling and exploring new places.</li>
            </ul>
          </div>
        </div>
      </section>

      <section className="flex flex-col gap-6 p-3 border border-gray-600 mx-auto my-6 sm:my-10 max-w-6xl h-auto rounded-lg">
        ...
        <p className="text-white/70 font-semibold text-sm md:text-md font-openSans text-center px-2 sm:px-0">
      ...
      <section className="flex flex-col gap-3 p-2 border border-gray-600 mx-auto my-6 sm:my-10 max-w-6xl h-auto rounded-lg">
        ...
        <div className="w-full mx-auto space-y-4 my-4 px-1 sm:px-0">
